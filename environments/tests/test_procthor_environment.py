...
# from environments.core import SimulationEnvironmentInterface as Simulator
...
#     move_op = environments.simulator.operators.construct_move_operator(move_time_fn)
#     search_op = environments.simulator.operators.construct_search_operator(object_find_prob, search_time)
...
#     move_op = environments.simulator.operators.construct_move_operator(move_time_fn)
#     search_op = environments.simulator.operators.construct_search_operator(object_find_prob, search_time)
#     pick_op = environments.simulator.operators.construct_pick_operator(pick_time)
#     place_op = environments.simulator.operators.construct_place_operator(place_time)
