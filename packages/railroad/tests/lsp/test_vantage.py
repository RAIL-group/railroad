...
def test_count_cells_in_polygon() -> None:
    polygon = square_polygon(0, 0, 10, 10)
...
def test_select_best_vantage_prefers_more_visible_cells() -> None:
    frontier = make_frontier("f", [(5, 5), (5, 6), (5, 7)])
    sees_all = _record(2.0, (20.0, 20.0), square_polygon(0, 0, 10, 10))
    sees_one = _record(1.0, (1.0, 1.0), square_polygon(4, 4, 6, 6))
...
def test_select_best_vantage_skips_missing_polygons_and_blind_views() -> None:
    ...
    blind = _record(2.0, (50.0, 50.0), square_polygon(40, 40, 60, 60))
